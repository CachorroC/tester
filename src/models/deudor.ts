...
export class ClassDeudor implements IntDeudor {
  constructor({ cedula, direccion, email, nombre, telefono = "" }: DeudorRaw) {
    ...
    switch (nameArrayLength) {
      ...
      case 3:
        [this.primerNombre, this.primerApellido, this.segundoApellido] =
          nameStringArray;
        this.segundoNombre = null;
